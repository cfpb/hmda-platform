...
object LoanProduct extends Enum[LoanProduct] {
  ...
  case object ConventionalSubordinate extends LoanProduct("Conventional, Subordinate Lien")
  ...
  def validateLoanProducts(
    ...
    val isValidLoanProducts = potentialLoanProducts.map(_._2).forall(_.isDefined)
