...
import hmda.validation.stats.ValidationStats.FindQ071
...
class Q071 private (institution: Institution, year: Int) extends AggregateEditCheck[LoanApplicationRegisterSource, LoanApplicationRegister] with StatsLookup {
