...
import hmda.validation.messages.ValidationStatsMessages.{ AddSubmissionLarStatsActorRef, FindQ071 }
...
class Q071Spec extends MacroSpecWithValidationStats {
  ...
  "Q071" must {
    ...
    "set up: persist last year's data: sold 60% of loans" in {
      ...
      validationStats ! AddSubmissionMacroStats(submissionId, 0, 0, 0, 100, 60, 0, 0, 0, 0)
