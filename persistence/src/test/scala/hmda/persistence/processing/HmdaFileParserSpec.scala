...
import hmda.persistence.messages.events.processing.HmdaFileParserEvents.{ LarParsedErrors, TsParsed, TsParsedErrors }
...
class HmdaFileParserSpec extends ActorSpec with BeforeAndAfterEach with HmdaFileParserSpecUtils {
  ...
  "HMDA File Parser" must {
    ...
    "get paginated results with GetStatePaginated(page)" in {
      ...
      // All pages should include the TS errors
      // First page should have 20 LAR errors
      ...
      page1.larParsingErrors.size mustBe 20
      ...
      page2.tsParsingErrors mustBe tsErrors
      ...
      page3.tsParsingErrors mustBe tsErrors
