...
-- Name: qa_ts_prv_table_2019; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_ts_prv_table_2019 (
    id integer NOT NULL,
...
ALTER TABLE hmda_user.qa_ts_prv_table_2019 OWNER TO hmda_user;
