-- Table: hmda_user.ts2020_q1

-- DROP TABLE hmda_user.ts2020_q1;

CREATE TABLE hmda_user.ts2020_q1
(
    id integer,
...
ALTER TABLE hmda_user.ts2020_q1
    OWNER to hmda_user;

GRANT ALL ON TABLE hmda_user.ts2020_q1 TO hmda_user;

GRANT SELECT ON TABLE hmda_user.ts2020_q1 TO hmda_user_rd;