-- Table: hmda_user.ts2022_q2

-- DROP TABLE hmda_user.ts2022_q2;

CREATE TABLE hmda_user.ts2022_q2
(
    id integer,
...
ALTER TABLE hmda_user.ts2022_q2
    OWNER to hmda_user;

GRANT ALL ON TABLE hmda_user.ts2022_q2 TO hmda_user;

GRANT SELECT ON TABLE hmda_user.ts2022_q2 TO hmda_user_rd;