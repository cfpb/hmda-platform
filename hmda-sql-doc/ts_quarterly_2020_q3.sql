-- Table: hmda_user.ts2020_q3

-- DROP TABLE hmda_user.ts2020_q3;

CREATE TABLE hmda_user.ts2020_q3
(
    id integer,
...
ALTER TABLE hmda_user.ts2020_q3
    OWNER to hmda_user;

GRANT ALL ON TABLE hmda_user.ts2020_q3 TO hmda_user;

GRANT SELECT ON TABLE hmda_user.ts2020_q3 TO hmda_user_rd;