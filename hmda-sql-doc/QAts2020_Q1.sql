...
-- Name: qa_ts_table_2020_q1; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_ts_table_2020_q1 (
    id integer NOT NULL,
...
ALTER TABLE hmda_user.qa_ts_table_2020_q1 OWNER TO hmda_user;

--
-- TOC entry 5444 (class 2606 OID 20734)
-- Name: qa_ts_table_2020_q1 ts2018_qa_prv_pkey; Type: CONSTRAINT; Schema: hmda_user; Owner: hmda_user
--
