...
-- Name: qa_lar_table_2020_q3; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_lar_table_2020_q3 (
  id integer NOT NULL,
...
ALTER TABLE hmda_user.qa_lar_table_2020_q3 OWNER TO hmda_user;
