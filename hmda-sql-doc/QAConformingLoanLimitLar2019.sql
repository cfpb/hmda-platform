...
-- Name: qa_lar_loanlimit_table_2019; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_lar_loanlimit_table_2019 (
id integer,
msa_id character varying COLLATE pg_catalog."default",
...
ALTER TABLE hmda_user.qa_lar_loanlimit_table_2019 OWNER TO hmda_user;
