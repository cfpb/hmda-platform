...
-- Name: qa_lar_table_2020; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_lar_table_2020 (
  id integer NOT NULL,
...
ALTER TABLE hmda_user.qa_lar_table_2020 OWNER TO hmda_user;
