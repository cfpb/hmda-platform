-- Table: hmda_user.qa_panel_table_2020

-- DROP TABLE hmda_user.qa_panel_table_2020;

CREATE TABLE hmda_user.qa_panel_table_2020
(
...
ALTER TABLE hmda_user.qa_panel_table_2020
    OWNER to hmda_user;

GRANT ALL ON TABLE hmda_user.qa_panel_table_2020 TO hmda_user;

GRANT SELECT ON TABLE hmda_user.qa_panel_table_2020 TO hmda_user_rd;