...
-- Name: qa_lar_table_2021_q2; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_lar_table_2021_q2 (
  id integer NOT NULL,
...
ALTER TABLE hmda_user.qa_lar_table_2021_q2 OWNER TO hmda_user;
