...
-- Name: qa_ts_pub_table_2018; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_ts_pub_table_2018 (
    id integer NOT NULL,
...
ALTER TABLE hmda_user.qa_ts_pub_table_2018 OWNER TO hmda_user;

--
-- TOC entry 5444 (class 2606 OID 20734)
-- Name: qa_ts_pub_table_2018 ts2018_qa_pub_pkey; Type: CONSTRAINT; Schema: hmda_user; Owner: hmda_user
--

ALTER TABLE ONLY hmda_user.qa_ts_pub_table_2018
    ADD CONSTRAINT ts2018_qa_pub_pkey PRIMARY KEY (lei);
