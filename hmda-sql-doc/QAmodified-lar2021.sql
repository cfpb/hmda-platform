...
-- Name: qa_mlar_table_2021; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_mlar_table_2021 (
    id integer,
...
ALTER TABLE hmda_user.qa_mlar_table_2021 OWNER TO hmda_user;
