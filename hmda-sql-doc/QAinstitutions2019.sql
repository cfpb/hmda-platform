-- Table: hmda_user.qa_panel_table_2019

-- DROP TABLE hmda_user.qa_panel_table_2019;

CREATE TABLE hmda_user.qa_panel_table_2019
(
...
ALTER TABLE hmda_user.qa_panel_table_2019
    OWNER to hmda_user;

GRANT ALL ON TABLE hmda_user.qa_panel_table_2019 TO hmda_user;

GRANT SELECT ON TABLE hmda_user.qa_panel_table_2019 TO hmda_user_rd;