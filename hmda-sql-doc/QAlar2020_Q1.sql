...
-- Name: qa_lar_table_2020_q1; Type: TABLE; Schema: hmda_user; Owner: hmda_user
--

CREATE TABLE hmda_user.qa_lar_table_2020_q1 (
  id integer NOT NULL,
...
ALTER TABLE hmda_user.qa_lar_table_2020_q1 OWNER TO hmda_user;
