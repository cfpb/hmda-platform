...
import hmda.regulator.query.lar._2018.LarEntityImpl2018
import hmda.regulator.query.lar._2019.LarEntityImpl2019
...
class LarScheduler extends HmdaActor with RegulatorComponent2018 with RegulatorComponent2019 {
  ...
  override def preStart() = {
    QuartzSchedulerExtension(context.system).schedule("LarScheduler2018", self, LarScheduler2018)
    QuartzSchedulerExtension(context.system).schedule("LarScheduler2018", self, LarScheduler2018)
