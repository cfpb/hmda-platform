...
import hmda.regulator.scheduler.schedules.Schedules.{TsScheduler2018, TsScheduler2019}

import scala.concurrent.Future
import scala.util.{Failure, Success}

class TsScheduler extends HmdaActor with RegulatorComponent2018 with RegulatorComponent2019 {
  ...
  override def preStart() = {
    QuartzSchedulerExtension(context.system).schedule("TsScheduler2018", self, TsScheduler2018)

    QuartzSchedulerExtension(context.system).schedule("TsScheduler2019", self, TsScheduler2019)
  ...
  override def receive: Receive = {
    ...
    case TsScheduler2018 =>
      ...
      val allResults: Future[Seq[_2018.TransmittalSheetEntity]] =
    ...
    case TsScheduler2019 =>
      ...
      val allResults: Future[Seq[_2019.TransmittalSheetEntity]] =
