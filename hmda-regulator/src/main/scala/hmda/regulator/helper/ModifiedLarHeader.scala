...
trait ModifiedLarHeader {
  ...
  val MLARHeader =
    "activity_year|lei|derived_msa-md|state_code|" +
      ...
      "initially_payable_to_institution|aus-1|aus-2|aus-3|aus-4|aus-5|denial_reason-1|" +
      "denial_reason-2|denial_reason-3|denial_reason-4|tract_population|" +
      "tract_minority_population_percent|ffiec_msa_md_median_family_income|" +
      "tract_to_msa_income_percentage|(median|tract|income||MSA|median)|" +
