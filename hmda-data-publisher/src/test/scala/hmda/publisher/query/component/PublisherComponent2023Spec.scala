...
class PublisherComponent2023Spec
  ...
  "InstitutionRepository2023 runthrough" taggedAs CustomTag in {
  ...
  "TransmittalSheetRepository2023 runthrough" taggedAs CustomTag in {
    import tsRepo._
  ...
  "LarRepository2023 runthrough" taggedAs CustomTag in {
    import larRepo._
