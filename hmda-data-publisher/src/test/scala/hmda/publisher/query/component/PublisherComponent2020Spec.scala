...
class PublisherComponent2020Spec
  ...
  "InstitutionRepository2020 runthrough" taggedAs CustomTag in {
  ...
  "TransmittalSheetRepository2020 runthrough" taggedAs CustomTag in {
    import tsRepo._
  ...
  "LarRepository2020 runthrough" taggedAs CustomTag in {
    import larRepo._
