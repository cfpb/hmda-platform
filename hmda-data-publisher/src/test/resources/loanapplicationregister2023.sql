CREATE TABLE loanapplicationregister2023
(
    id                                integer                                   NOT NULL,
    ...
    is_quarterly                      boolean                     DEFAULT false NOT NULL, -- New for 2023 and beyond quarterly filing
    created_at                        timestamp without time zone DEFAULT now(),
    msa_md character varying,
    msa_md_name                       character varying
);

create table lar2023_q1 as select * from loanapplicationregister2023 where true = false;
create table lar2023_q2 as select * from loanapplicationregister2023 where true = false;
create table lar2023_q3 as select * from loanapplicationregister2023 where true = false;