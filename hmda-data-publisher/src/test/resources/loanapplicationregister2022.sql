CREATE TABLE loanapplicationregister2022
(
    id                                integer                                   NOT NULL,
    ...
    is_quarterly                      boolean                     DEFAULT false NOT NULL, -- New for 2022 and beyond quarterly filing
    created_at                        timestamp without time zone DEFAULT now(),
    msa_md character varying,
    msa_md_name                       character varying
);

create table lar2022_q1 as select * from loanapplicationregister2022 where true = false;
create table lar2022_q2 as select * from loanapplicationregister2022 where true = false;
create table lar2022_q3 as select * from loanapplicationregister2022 where true = false;