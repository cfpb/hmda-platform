...
trait PublisherComponent2018 extends PGTableNameLoader {
  ...
  class TransmittalSheetRepository2018(val config: DatabaseConfig[JdbcProfile]) extends TableRepository[TransmittalSheetTable, String] {
  ...
  abstract class LarTableBase[T](tag: Tag, tableName: String) extends Table[T](tag, tableName) {
    ...
    def larEntityImpl2018Projection =
      ...
      ) <> ((LarEntityImpl2018.apply _).tupled, LarEntityImpl2018.unapply)
    ...
    def larPartOneProjection =
      (
        ...
        county,
        tract
      ) <> ((LarPartOne2018.apply _).tupled, LarPartOne2018.unapply)
    ...
    def larPartTwoProjection =
      (
        ...
        raceApplicant4,
        raceApplicant5
      ) <> ((LarPartTwo2018.apply _).tupled, LarPartTwo2018.unapply)
    ...
    def larPartThreeProjection =
      (
        ...
        ageCoApplicant,
        income
      ) <> ((LarPartThree2018.apply _).tupled, LarPartThree2018.unapply)
    ...
    def larPartFiveProjection =
      ...
      ) <> ((LarPartFive2018.apply _).tupled, LarPartFive2018.unapply)
    ...
    def larPartSixProjection =
      ...
      ) <> ((LarPartSix2018.apply _).tupled, LarPartSix2018.unapply)
  ...
  class LarRepository2018(val config: DatabaseConfig[JdbcProfile]) extends TableRepository[LarTable, String] {
    ...
    def getAllLARs(bankIgnoreList: Array[String]): DatabasePublisher[LarEntityImpl2018] =
      db.stream(
