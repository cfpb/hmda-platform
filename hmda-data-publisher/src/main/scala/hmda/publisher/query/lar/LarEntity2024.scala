...
object LarPartOne2024 extends PsvParsingCompanion[LarPartOne2024] {
  override val psvReader: cormorant.Read[LarPartOne2024] = cormorant.generic.semiauto.deriveRead
}

case class LarPartTwo2024(
...
object LarPartTwo2024 extends PsvParsingCompanion[LarPartTwo2024] {
  override val psvReader: cormorant.Read[LarPartTwo2024] = cormorant.generic.semiauto.deriveRead
}

case class LarPartThree2024(
...
object LarPartThree2024 extends PsvParsingCompanion[LarPartThree2024] {
  override val psvReader: cormorant.Read[LarPartThree2024] = cormorant.generic.semiauto.deriveRead
}

case class LarPartFour2024(
                            purchaserType: Int = 0,
                            rateSpread: String = "",
                            hoepaStatus: Int = 0,
                            lienStatus: Int = 0,
...
object LarPartFour2024 extends PsvParsingCompanion[LarPartFour2024] {
  override val psvReader: cormorant.Read[LarPartFour2024] = cormorant.generic.semiauto.deriveRead
}

case class LarPartFive2024(
...
object LarPartFive2024 extends PsvParsingCompanion[LarPartFive2024] {
  override val psvReader: cormorant.Read[LarPartFive2024] = cormorant.generic.semiauto.deriveRead
}

case class LarPartSix2024(
                           payable: Int = 0,
                           nmls: String = "",
                           aus1: String = "",
                           aus2: String = "",
...
object LarPartSix2024 extends PsvParsingCompanion[LarPartSix2024] {
  override val psvReader: cormorant.Read[LarPartSix2024] = cormorant.generic.semiauto.deriveRead
}

case class LarPartSeven2024(
...
object LarPartSeven2024 extends PsvParsingCompanion[LarPartSeven2024] {
  override val psvReader: cormorant.Read[LarPartSeven2024] = { (a: CSV.Row) =>
    (for {
...
case class LarEntityImpl2024(
                              larPartOne: LarPartOne2024 = LarPartOne2024(),
                              larPartTwo: LarPartTwo2024 = LarPartTwo2024(),
                              larPartThree: LarPartThree2024 = LarPartThree2024(),
                              larPartFour: LarPartFour2024 = LarPartFour2024(),
                              larPartFive: LarPartFive2024 = LarPartFive2024(),
                              larPartSix: LarPartSix2024 = LarPartSix2024(),
                              larPartSeven: LarPartSeven2024 = LarPartSeven2024()
                            ) {
  ...
  def appendMsa(msa: Msa): LarEntityImpl2024WithMsa = LarEntityImpl2024WithMsa(this, msa)
...
object LarEntityImpl2024 extends PsvParsingCompanion[LarEntityImpl2024] {
  override val psvReader: cormorant.Read[LarEntityImpl2024] = { (a: CSV.Row) =>
    (for {
      (rest, p1) <- enforcePartialRead(LarPartOne2024.psvReader, a)
      (rest, p2) <- enforcePartialRead(LarPartTwo2024.psvReader, rest)
      (rest, p3) <- enforcePartialRead(LarPartThree2024.psvReader, rest)
      (rest, p4) <- enforcePartialRead(LarPartFour2024.psvReader, rest)
      (rest, p5) <- enforcePartialRead(LarPartFive2024.psvReader, rest)
      p6OrMore   <- LarPartSix2024.psvReader.readPartial(rest)
    } yield p6OrMore match {
      case Left((row, p6)) => Left((row, LarEntityImpl2024(p1, p2, p3, p4, p5, p6)))
      case Right(p6)       => Right(LarEntityImpl2024(p1, p2, p3, p4, p5, p6))
    })
  }
}

case class LarEntityImpl2024WithMsa(
                                     larEntityImpl2024: LarEntityImpl2024,
                                     msa: Msa
                                   ) {
  def toRegulatorPSV: String = {
    import larEntityImpl2024._
    (larPartOne.toRegulatorPSV +
      larPartTwo.toRegulatorPSV +
      larPartThree.toRegulatorPSV +
      larPartFour.toRegulatorPSV +
...
object LarEntityImpl2024WithMsa extends PsvParsingCompanion[LarEntityImpl2024WithMsa] {
  override val psvReader: cormorant.Read[LarEntityImpl2024WithMsa] = { (a: CSV.Row) =>
    (for {
      (rest, lar)     <- enforcePartialRead(LarEntityImpl2024.psvReader, a)
      (rest, p7)      <- enforcePartialRead(LarPartSeven2024.psvReader, rest)
      (rest, msaId)   <- enforcePartialRead(readNext[String], rest)
      msaName <- readNext[String].read(rest)
    } yield LarEntityImpl2024WithMsa(lar.copy(larPartSeven = p7), Msa(msaId, msaName))).map(Right(_))
  }
}
// $COVERAGE-ON$