...
object LarPartOne2026 extends PsvParsingCompanion[LarPartOne2026] {
  override val psvReader: cormorant.Read[LarPartOne2026] = cormorant.generic.semiauto.deriveRead
}

case class LarPartTwo2026(
...
object LarPartTwo2026 extends PsvParsingCompanion[LarPartTwo2026] {
  override val psvReader: cormorant.Read[LarPartTwo2026] = cormorant.generic.semiauto.deriveRead
}

case class LarPartThree2026(
...
object LarPartThree2026 extends PsvParsingCompanion[LarPartThree2026] {
  override val psvReader: cormorant.Read[LarPartThree2026] = cormorant.generic.semiauto.deriveRead
}

case class LarPartFour2026(
                            purchaserType: Int = 0,
                            rateSpread: String = "",
                            hoepaStatus: Int = 0,
                            lienStatus: Int = 0,
...
object LarPartFour2026 extends PsvParsingCompanion[LarPartFour2026] {
  override val psvReader: cormorant.Read[LarPartFour2026] = cormorant.generic.semiauto.deriveRead
}

case class LarPartFive2026(
...
object LarPartFive2026 extends PsvParsingCompanion[LarPartFive2026] {
  override val psvReader: cormorant.Read[LarPartFive2026] = cormorant.generic.semiauto.deriveRead
}

case class LarPartSix2026(
                           payable: Int = 0,
                           nmls: String = "",
                           aus1: String = "",
                           aus2: String = "",
...
object LarPartSix2026 extends PsvParsingCompanion[LarPartSix2026] {
  override val psvReader: cormorant.Read[LarPartSix2026] = cormorant.generic.semiauto.deriveRead
}

case class LarPartSeven2026(
...
object LarPartSeven2026 extends PsvParsingCompanion[LarPartSeven2026] {
  override val psvReader: cormorant.Read[LarPartSeven2026] = { (a: CSV.Row) =>
    (for {
...
case class LarEntityImpl2026(
                              larPartOne: LarPartOne2026 = LarPartOne2026(),
                              larPartTwo: LarPartTwo2026 = LarPartTwo2026(),
                              larPartThree: LarPartThree2026 = LarPartThree2026(),
                              larPartFour: LarPartFour2026 = LarPartFour2026(),
                              larPartFive: LarPartFive2026 = LarPartFive2026(),
                              larPartSix: LarPartSix2026 = LarPartSix2026(),
                              larPartSeven: LarPartSeven2026 = LarPartSeven2026()
                            ) {
  ...
  def appendMsa(msa: Msa): LarEntityImpl2026WithMsa = LarEntityImpl2026WithMsa(this, msa)
...
object LarEntityImpl2026 extends PsvParsingCompanion[LarEntityImpl2026] {
  override val psvReader: cormorant.Read[LarEntityImpl2026] = { (a: CSV.Row) =>
    (for {
      (rest, p1) <- enforcePartialRead(LarPartOne2026.psvReader, a)
      (rest, p2) <- enforcePartialRead(LarPartTwo2026.psvReader, rest)
      (rest, p3) <- enforcePartialRead(LarPartThree2026.psvReader, rest)
      (rest, p4) <- enforcePartialRead(LarPartFour2026.psvReader, rest)
      (rest, p5) <- enforcePartialRead(LarPartFive2026.psvReader, rest)
      p6OrMore   <- LarPartSix2026.psvReader.readPartial(rest)
    } yield p6OrMore match {
      case Left((row, p6)) => Left((row, LarEntityImpl2026(p1, p2, p3, p4, p5, p6)))
      case Right(p6)       => Right(LarEntityImpl2026(p1, p2, p3, p4, p5, p6))
    })
  }
}

case class LarEntityImpl2026WithMsa(
                                     larEntityImpl2026: LarEntityImpl2026,
                                     msa: Msa
                                   ) {
  def toRegulatorPSV: String = {
    import larEntityImpl2026._
    (larPartOne.toRegulatorPSV +
      larPartTwo.toRegulatorPSV +
      larPartThree.toRegulatorPSV +
      larPartFour.toRegulatorPSV +
...
object LarEntityImpl2026WithMsa extends PsvParsingCompanion[LarEntityImpl2026WithMsa] {
  override val psvReader: cormorant.Read[LarEntityImpl2026WithMsa] = { (a: CSV.Row) =>
    (for {
      (rest, lar)     <- enforcePartialRead(LarEntityImpl2026.psvReader, a)
      (rest, p7)      <- enforcePartialRead(LarPartSeven2026.psvReader, rest)
      (rest, msaId)   <- enforcePartialRead(readNext[String], rest)
      msaName <- readNext[String].read(rest)
    } yield LarEntityImpl2026WithMsa(lar.copy(larPartSeven = p7), Msa(msaId, msaName))).map(Right(_))
  }
}
// $COVERAGE-ON$