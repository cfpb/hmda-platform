...
class APORProtobufSerializer extends SerializerWithStringManifest {
  ...
  final val CalculateRateSpreadManifest = classOf[CalculateRateSpread].getName
  ...
  override def toBinary(o: AnyRef): Array[Byte] = o match {
    ...
    case cmd: CalculateRateSpread => calculateRateSpreadToProtobuf(cmd).toByteArray
  ...
  override def fromBinary(bytes: Array[Byte], manifest: String): AnyRef = manifest match {
    ...
    case CalculateRateSpreadManifest =>
      calculateRateSpreadFromProtobuf(CalculateRateSpreadMessage.parseFrom(bytes))
