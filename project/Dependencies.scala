...
object Dependencies {
  ...
  val inMemoryPersistence = "com.github.dnvriend" %% "akka-persistence-inmemory" % Version.inMemoryPersistence
  exclude("com.github.dnvriend", "akka-persistence-query-writer")
