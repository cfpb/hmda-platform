...
object LarConverter {
  ...
  val countyLoanLimitFileName2026 =
    config.getString("hmda.countyLoanLimit.2026.fields.filename")
  ...
  val countyLoanLimits2026: Seq[CountyLoanLimit] =
    parseCountyLoanLimitFile(countyLoanLimitFileName2026)
  ...
  val overallLoanLimit2026 = overallLoanLimits(countyLoanLimits2026)
  ...
  val countyLoanLimitsByCounty2026 = countyLoansLimitByCounty(countyLoanLimits2026)
  ...
  val countyLoanLimitsByState2026 = countyLoansLimitByState(countyLoanLimits2026)
  ...
  def apply(
    ...
    LarEntity(
      ...
      ConformingLoanLimit.assignLoanLimit(lar, year, overallLoanLimit, countyLoanLimitsByCounty, countyLoanLimitsByState),
  ...
  private def getcountyLoanLimitsByCounty(year: Int) = {
    year match {
      ...
      case 2026 => countyLoanLimitsByCounty2026
  ...
  private def getcountyLoanLimitsByState(year: Int) = {
    year match {
      ...
      case 2026 => countyLoanLimitsByState2026
    }
  }
  ...
  private def getOverallLoanLimit(year: Int) = {
    year match {
      ...
      case 2026 => overallLoanLimit2026
