...
class V699Spec extends LarEditCheckSpec {
  ...
  property("AUS Results must be valid if AUS is Other AUS") {
    forAll(larGen) { lar =>
      ...
      relevantAUSLar1
        .copy(ausResult = relevantAUSLar1.ausResult.copy(ausResult1 = EmptyAUSResultValue))
        .mustFail
      relevantAUSLar2
        .copy(ausResult = relevantAUSLar2.ausResult.copy(ausResult2 = EmptyAUSResultValue))
        .mustFail
      relevantAUSLar3
        .copy(ausResult = relevantAUSLar3.ausResult.copy(ausResult3 = EmptyAUSResultValue))
        .mustFail
      relevantAUSLar4
        .copy(ausResult = relevantAUSLar4.ausResult.copy(ausResult4 = EmptyAUSResultValue))
        .mustFail
      relevantAUSLar5
        .copy(ausResult = relevantAUSLar5.ausResult.copy(ausResult5 = EmptyAUSResultValue))
        .mustFail
