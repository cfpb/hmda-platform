...
case class QualityEditSummaryResponse(edits: Seq[EditSummaryResponse], verified: Boolean)
case class MacroEditSummaryResponse(edits: Seq[EditSummaryResponse], verified: Boolean)
