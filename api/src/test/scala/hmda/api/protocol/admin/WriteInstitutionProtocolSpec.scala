    ...
    forAll(institutionGen) { i =>
      i.toJson mustBe
        JsObject(
          ...
          ("emailDomains", JsObject(
            ("email2015", JsString(i.emailDomains.email2015)),
            ("email2014", JsString(i.emailDomains.email2014)),
            ("email2013", JsString(i.emailDomains.email2013))
          )),
          ("respondent", JsObject(
            ("id", JsObject(
