DROP MATERIALIZED VIEW  IF EXISTS median_credit_score_by_loan_by_race_{mv_suffix};

create materialized view median_credit_score_by_loan_by_race_{mv_suffix} as
  select 
    now() as last_updated, 
    case 
