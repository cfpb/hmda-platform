DROP MATERIALIZED VIEW  IF EXISTS median_interest_rates_by_loan_type_{mv_suffix};

create materialized view median_interest_rates_by_loan_type_{mv_suffix} as
  select 
    now() as last_updated,
    case 
