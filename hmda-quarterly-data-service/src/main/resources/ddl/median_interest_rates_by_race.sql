create materialized view median_interest_rates_by_race_2018 as
	select now() last_updated, percentile_cont(0.5) within group(order by interest_rate ::numeric) median_interest_rate,
