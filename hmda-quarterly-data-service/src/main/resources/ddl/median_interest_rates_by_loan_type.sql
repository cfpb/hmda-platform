create materialized view median_interest_rates_by_loan_type_2018 as
	select now() last_updated,
		...
		line_of_credits loc,
		percentile_cont(0.5) within group(order by interest_rate ::numeric) median_interest_rate,
