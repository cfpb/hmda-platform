...
object MedianCLTVByTypeLoanPurposeHome extends RatesGraph(
  "ltv",
  "ltv-loan-purpose-home",
  BY_TYPE_TITLE,
  BY_TYPE_SUBTITLE,
  ...
  override protected def getSummaryByType(loanType: LoanTypeEnum, title: String, heloc: Boolean, conforming: Boolean): CancelableFuture[GraphSeriesSummary] =
    QuarterlyGraphRepo.fetchMedianCLTVByTypeLoanPurposeHome(loanType, heloc, conforming)
