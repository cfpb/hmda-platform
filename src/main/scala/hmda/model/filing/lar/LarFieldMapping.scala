...
object LarFieldMapping {
  def mapping(lar: LoanApplicationRegister): Map[String, Any] = Map(
    ...
    "Legal Entity Identifier" -> lar.LEI,
    ...
    "Interest Rate" -> lar.interestRate,
    "Prepayment Penalty Term" -> lar.prepaymentPenaltyTerm,
    "Debt-to-Income Ration" -> lar.debtToIncomeRatio,
    "Combined Loan-to-Value Ration" -> lar.loanToValueRatio,
    "Loan Term" -> lar.loan.loanTerm,
    "Introductory Rate Period" -> lar.introductoryRatePeriod,
    ...
    "Property Value" -> lar.propertyValue,
    "Manufactured Home Secured Property Type" -> lar.manufacturedHomeSecuredProperty,
    "Manufactured Home Land Property Interest" -> lar.manufacturedHomeLandPropertyInterestEnum,
    "Total Units" -> lar.totalUnits,
    "Multifamily Affordable Units" -> lar.multiFamilyAffordableUnits,
    ...
    "Mortgage Loan Originator NMLSR Identifier" -> lar.NMLSRIdentifier,
