...
sealed trait LarFormatValidator extends LarParser {
  ...
  def validateLarValues(
    ...
    (
      ...
      validateProperty(propertyValue,
                       ...
                       totalUnits,
                       multifamilyAffordableUnits),
      validateLarCode(ApplicationSubmissionEnum, submissionOfApplication, InvalidApplicationSubmission),
      validateLarCode(PayableToInstitutionEnum, payableToInstitution, InvalidPayableToInstitution),
      ...
      validateLarCode(LineOfCreditEnum, openEndLineOfCredit, InvalidLineOfCredit),
      validateLarCode(BusinessOrCommercialBusinessEnum, businessOrCommercial, InvalidBusinessOrCommercial)
  ...
  def validateLoan(
    ...
    (
      ...
      validateLarCode(ConstructionMethodEnum, constructionMethod, InvalidConstructionMethod),
      ...
      validateIntStrOrNAOrExemptField(prepaymentPenalty, InvalidPrepaymentPenaltyTerm),
      validateDoubleStrOrNAOrExemptField(debtToIncome, InvalidDebtToIncomeRatio),
      validateDoubleStrOrNAOrExemptField(loanToValue, InvalidLoanToValueRatio),
      validateIntStrOrNAOrExemptField(introductoryRate, InvalidIntroductoryRatePeriod)
    ).mapN(Loan)
  ...
  def validateLoanDisclosure(
    ...
    (
      ...
      validateDoubleStrOrNAOrExemptField(totalPointsAndFees, InvalidPointsAndFees),
      validateDoubleStrOrNAOrExemptField(originationCharges, InvalidOriginationCharges),
      validateDoubleStrOrNAOrExemptOrEmptyField(discountPoints, InvalidDiscountPoints),
      validateDoubleStrOrNAOrExemptOrEmptyField(lenderCredits, InvalidLenderCredits)
    ).mapN(LoanDisclosure)
  ...
  def validateNonAmortizingFeatures(
    ...
    (
      ...
      validateLarCode(InterestOnlyPaymentsEnum, interestOnlyPayment, InvalidInterestOnlyPayment),
      validateLarCode(NegativeAmortizationEnum, negativeAmortization, InvalidNegativeAmortization),
      validateLarCode(OtherNonAmortizingFeaturesEnum, otherNonAmortizingFeatures, InvalidOtherNonAmortizingFeatures)
  ...
  def validateProperty(
    ...
    (
      ...
      validateLarCode(ManufacturedHomeSecuredPropertyEnum, manufacturedHomeSecuredProperty, InvalidManufacturedHomeSecuredProperty),
  ...
  def validateAus(
    ...
    (
      validateLarCode(AutomatedUnderwritingSystemEnum, aus1, InvalidAutomatedUnderwritingSystem),
      validateLarCodeOrEmptyField(AutomatedUnderwritingSystemEnum, aus2, InvalidAutomatedUnderwritingSystem),
      validateLarCodeOrEmptyField(AutomatedUnderwritingSystemEnum, aus3, InvalidAutomatedUnderwritingSystem),
      validateLarCodeOrEmptyField(AutomatedUnderwritingSystemEnum, aus4, InvalidAutomatedUnderwritingSystem),
      validateLarCodeOrEmptyField(AutomatedUnderwritingSystemEnum, aus5, InvalidAutomatedUnderwritingSystem),
  ...
  def validateAusResult(
    ...
    (
      validateLarCode(AutomatedUnderwritingResultEnum, ausResult1, InvalidAutomatedUnderwritingSystemResult),
      validateLarCodeOrEmptyField(AutomatedUnderwritingResultEnum, ausResult2, InvalidAutomatedUnderwritingSystemResult),
      validateLarCodeOrEmptyField(AutomatedUnderwritingResultEnum, ausResult3, InvalidAutomatedUnderwritingSystemResult),
      validateLarCodeOrEmptyField(AutomatedUnderwritingResultEnum, ausResult4, InvalidAutomatedUnderwritingSystemResult),
      validateLarCodeOrEmptyField(AutomatedUnderwritingResultEnum, ausResult5, InvalidAutomatedUnderwritingSystemResult),
