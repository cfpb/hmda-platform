...
object EditDetailsCommandsProtobufConverter {
  ...
  def persistEditDetailsToProtobuf(
      ...
      refResolver: ActorRefResolver): PersistEditDetailsMessage = {
  ...
  def persistEditDetailsFromProtobuf(
      msg: PersistEditDetailsMessage,
      refResolver: ActorRefResolver): PersistEditDetails = {
  ...
  def getEditDetailsToProtobuf(
      cmd: GetEditDetails,
      refResolver: ActorRefResolver): GetEditDetailsMessage = {
  ...
  def getEditDetailsFromProtobuf(
      msg: GetEditDetailsMessage,
      refResolver: ActorRefResolver): GetEditDetails = {
    GetEditDetails(
