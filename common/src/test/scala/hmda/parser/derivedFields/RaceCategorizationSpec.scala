...
class RaceCategorizationSpec
  ...
  property("Race Categorization must identify race categories") {
    ...
    forAll(larGen) { lar =>
        ...
        val americanIndianLar1 = lar.copy(applicant = lar.applicant.copy(race = americanIndianRace), coApplicant = lar.coApplicant.copy(race = noCoRace))
        val americanIndianLar2 = lar.copy(applicant = lar.applicant.copy(race = americanIndianWhiteRace), coApplicant = lar.coApplicant.copy(race = noCoRace))
        ...
        val pacificIslanderLar1 = lar.copy(applicant = lar.applicant.copy(race = pacificIslanderRace), coApplicant = lar.coApplicant.copy(race = noCoRace))
        val pacificIslanderLar2 = lar.copy(applicant = lar.applicant.copy(race = pacificIslanderWhiteRace), coApplicant = lar.coApplicant.copy(race = noCoRace))

        val jointLar1 = lar.copy(applicant = lar.applicant.copy(race = pacificIslanderRace), coApplicant = lar.coApplicant.copy(race = whiteRace))
        val jointLar2 = lar.copy(applicant = lar.applicant.copy(race = whiteRace), coApplicant = lar.coApplicant.copy(race = asianRace))
        val jointLar3 = lar.copy(applicant = lar.applicant.copy(race = americanIndianRace), coApplicant = lar.coApplicant.copy(race = whiteRace))
        ...
        val pacificIslanderJointLar = lar.copy(applicant = lar.applicant.copy(race = pacificIslanderWhiteRace), coApplicant = lar.coApplicant.copy(race = whiteRace))
        val americanIndianJointLar = lar.copy(applicant = lar.applicant.copy(race = americanIndianWhiteRace), coApplicant = lar.coApplicant.copy(race = whiteRace))
        val asianJointLar = lar.copy(applicant = lar.applicant.copy(race = asianWhiteRace), coApplicant = lar.coApplicant.copy(race = whiteRace))
        val blackJointLar = lar.copy(applicant = lar.applicant.copy(race = blackWhiteRace), coApplicant = lar.coApplicant.copy(race = whiteRace))
